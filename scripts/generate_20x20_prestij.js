#!/usr/bin/env node
/**
 * 20×20 Prestij Crossword Chapter Generator
 *
 * Generates 60 premium 20×20 crossword puzzles organized into chapters:
 *   - 20 EASY chapters
 *   - 20 MEDIUM chapters
 *   - 20 HARD chapters
 *
 ...
 *
 * Output: src/data/premium_20x20.json
 */
...
const OUT_PATH = path.join(__dirname, '../src/data/premium_20x20.json');
...
function main() {
    console.log('═══════════════════════════════════════');
    console.log(' 20×20 Prestij Crossword Generator');
    console.log('═══════════════════════════════════════');
